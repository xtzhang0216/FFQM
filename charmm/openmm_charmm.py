...
def calc_ene(crd_file):
    ...
    psf = ForceField('/pubhome/xtzhang/interaction/FF/charmm/charmm36.zxt.clear.xml','charmm36/water.xml')
...
def main():
    parser = argparse.ArgumentParser(description='CHARMM OpenMM energy calculation')
    parser.add_argument('--xyz', type=str, default="ETOH_MIME", help='xyz name, e.g. ACEM_HOH_00')
    parser.add_argument('--start', type=int, default=344, help='start index for sdf conformers')
    parser.add_argument('--end', type=int, default=350, help='end index for sdf conformers (exclusive)')
