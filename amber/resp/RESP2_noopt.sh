...
Multiwfn_noGUI  gau.fchk -ispecial 1 > /dev/null << EOF
7
18
8
1
...
echo Please properly cite Multiwfn_noGUI  in your publication according to \"How to cite Multiwfn_noGUI .pdf\" in Multiwfn_noGUI  package
