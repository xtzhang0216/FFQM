...
def gen_box_pdb(psf, pdb):
    ...
    boxlx = (max_crds[0] - min_crds[0]).value_in_unit(angstroms) +100
    boxly = (max_crds[1] - min_crds[1]).value_in_unit(angstroms) +100
    boxlz = (max_crds[2] - min_crds[2]).value_in_unit(angstroms) +100
